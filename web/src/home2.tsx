...
// Alternate home: no nav bar. The Stats screen is the index, with a floating chat
...
export default function Home2() {
	...
	return (
		<div className="relative h-[100svh] overflow-hidden bg-white">
			...
			<div
				className={`absolute inset-x-0 bottom-0 top-[46%] bg-white rounded-t-[32px] shadow-[0_-10px_30px_rgba(0,0,0,0.14)] flex flex-col transition-opacity duration-300 ${
