...
## Source of truth
- **`tools/char-pipeline/blender/character_master.blend`** — the canonical
...
can never drift:
- **Shirt:** `tools/char-pipeline/scripts/build_shirt.py` — duplicates the
...
- **Pants** (skinned): `tools/char-pipeline/scripts/build_pants.py` →
...
- **Hat** (rigid, `bone:Head`): `tools/char-pipeline/scripts/build_hat.py`
...
- **Shoes** (rigid, two meshes): `tools/char-pipeline/scripts/build_shoes.py`
