...
export const metadata: Metadata = {
	...
	description: "Sidekick Terms of Service",
};
		...
		<div className="legal-page">
			...
			<main className="flex-1 max-w-3xl mx-auto px-6 py-12">
				...
				<div className="prose prose-gray prose-sm max-w-none [&_h2]:text-lg [&_h2]:font-medium [&_h2]:tracking-tight [&_h2]:mt-10 [&_h2]:mb-3 [&_h3]:text-base [&_h3]:font-medium [&_h3]:mt-6 [&_h3]:mb-2 [&_p]:leading-relaxed [&_li]:leading-relaxed">
					<p>
						We are Sans Software LLC (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot;
						&quot;our&quot; )
					</p>

					<p>
						We operate the website sidekickchat.app (the &quot;Site&quot;), the mobile application
						Sidekick (the &quot;App&quot;), as well as any other related products and services that
						refer or link to these legal terms (the &quot;Legal Terms&quot;) (collectively, the
						&quot;Services&quot;).
					</p>

					<p>You can contact us by email at hello@sidekickchat.app</p>

					<p>, United States</p>

					<p>
						These Legal Terms constitute a legally binding agreement made between you, whether
						personally or on behalf of an entity ( &quot;you&quot;), and Sans Software LLC,
					...
					<p>
						...
						hello@sidekickchat.app. If we ever grant you the permission to post, reproduce, or publicly
					...
					<p>( 3 ) you have the legal capacity and you agree to comply with these Legal Terms;</p>
					...
					<p>
						...
						for any such amounts upon placing your order. We reserve the right to correct any errors
					...
					<p>
						We offer a variable-day free trial to new users who register with the Services. The
						account will be charged according to the user&apos;s chosen subscription at the end of
						the free trial.
					</p>
					...
					<p>
						...
						then we grant to you a non-exclusive, revocable, personal, and non-transferable license
						to use such software solely in connection with our services and in accordance with these
						...
						or non-infringement. You accept any and all risk arising out of use or performance of
					...
					<p>By posting your Contributions to any part of the Services</p>
					...
					<p>
						...
						Google Play (each an &quot;App Distributor&quot;) to access the Services: (1) the
						...
						support services with respect to the App as specified in the terms and conditions of
						...
						whatsoever to furnish any maintenance and support services with respect to the App; (3)
						...
						warranty obligation whatsoever with respect to the App; (4) you represent and warrant
						that (i) you are not located in a country that is subject to a US government embargo, or
						...
						of agreement when using the App, e.g., if you have a VoIP application, then you must not
						...
						terms and conditions in this mobile application license contained in these Legal Terms,
					...
					<p>
						...
						simply provide the space to place such advertisements, and we have no other relationship
						with advertisers.
					</p>
					...
					<p>, and you expressly consent to have your data transferred to and processed in</p>
					...
					<p>the State of Delaware</p>

					<p>applicable to agreements made and to be entirely performed within</p>

					<p>the State of Delaware</p>

					<p>, without regard to its conflict of law principles.</p>
					...
					<p>THE AMOUNT PAID, IF ANY, BY YOU TO US</p>

					<p>DURING THE six (6) mONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING</p>
					...
					<p>
						...
						representations and warranties set forth in these Legal Terms; ( 5 ) your violation of
						the rights of a third party, including but not limited to intellectual property rights;
						or ( 6 ) any overt harmful act toward any other user of the Services with whom you
					...
					<h2>28. CALIFORNIA USERS AND RESIDENTS</h2>
					...
					<p>Sans Software LLC</p>

					<p>United States</p>

					<p>hello@sidekickchat.app</p>
				</div>
			</main>
