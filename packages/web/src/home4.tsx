...
export default function Home4() {
	...
	return (
		<div className="relative h-[100svh] overflow-hidden bg-white">
			...
			{/* Streak entrypoint — top right, above the scene */}
			<button
				onClick={() => setStreakOpen(true)}
				aria-label="Streak"
				className={`absolute right-4 top-[max(env(safe-area-inset-top),16px)] z-30 flex items-center gap-1.5 rounded-full bg-white/85 px-3.5 py-2 shadow-[0_3px_0_rgba(0,0,0,0.12)] backdrop-blur-sm transition-all duration-300 active:translate-y-[2px] active:shadow-[0_1px_0_rgba(0,0,0,0.12)] ${
